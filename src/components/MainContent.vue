...
import { getMediaPreviewTabs, isMediaPath, resolveWorkspaceFilePath } from '@/common/util/main-content-routing'
import type { MarkdownOutlineItem } from '@/common/interface/MarkdownOutlineItem'
import { FILE_TREE_CREATE_FILE_EVENT } from '@/common/util/file-tree-utils'
import { isTextEditingTarget } from '@/common/util/editing-target'
